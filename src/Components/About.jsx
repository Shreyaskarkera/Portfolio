...
const About = () => {
    return (
        <>
            <div className="mt-[1px] md:mt-[50px] lg:mt-[100px] px-4 sm:px-2 md:px-12 lg:px-24">
                {/* ABOUT Heading */}
                <motion.p
                ...
                >
                    <span className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-normal text-[var(--maintext-color)] tracking-[0.12em] md:tracking-[0.20em] mt-8">
                        ABOUT
                    </span>
                </motion.p>
                ...
                <motion.p
                    ...
                    className="mt-6 sm:mt-8 text-base sm:text-lg md:text-2xl lg:text-4xl leading-relaxed sm:leading-7 md:leading-10 lg:leading-[3rem] tracking-wide text-[var(--text-color)]"
                >
